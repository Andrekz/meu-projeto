...
export default function ModalDenuncia() {
  ...
  return (
    <>
      ...
      >
        <Megaphone size={16} /> Fazer nova denúncia
      </button>
          ...
          <div className="bg-zinc-900 border border-zinc-800 w-full max-w-lg rounded-2xl p-6 shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                className="text-zinc-400 hover:text-white bg-zinc-800 hover:bg-zinc-700 w-8 h-8 rounded-full flex items-center justify-center transition-colors"
              >
                <X size={14} />
              </button>
            </div>
            ...
            {erro && (
              <p className="bg-red-950 border border-red-900 text-red-400 p-3 rounded-xl text-sm mb-4 flex items-center gap-2">
            ...
            <form action={handleSubmit} className="flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                >
                  ...
                  <option value="Via deserta">Via deserta / Sem movimento</option>
              ...
              <p className="text-[10px] text-zinc-600 -mt-2">
                O endereço será geocodificado automaticamente para aparecer no mapa.
              </p>
